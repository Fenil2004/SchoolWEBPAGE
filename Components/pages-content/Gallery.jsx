    ...
    <div>
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#0A94B8] to-[#056C8C] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">Gallery</h1>
          ...
          >
            <Tabs value={activeCategory} onValueChange={setActiveCategory}>
              <TabsList className="bg-white shadow-sm">
                ...
                <TabsTrigger value="campus" className="px-6">Campus</TabsTrigger>
                <TabsTrigger value="classroom" className="px-6">Classroom</TabsTrigger>
                <TabsTrigger value="lab" className="px-6">Labs</TabsTrigger>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Journey of Angels School', thumbnail: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400&auto=format&fit=crop&q=80' },
              { title: 'Student Success Stories', thumbnail: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=400&auto=format&fit=crop&q=80' },
              { title: 'Campus Tour', thumbnail: 'https://images.unsplash.com/photo-1562774053-701939374585?w=400&auto=format&fit=crop&q=80' },
            ].map((video, index) => (
              <motion.div
                key={video.title}
