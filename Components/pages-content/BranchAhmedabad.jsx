...
export default function BranchAhmedabad() {
  const branchInfo = {
    ...
    email: 'ahmedabad@Angels School.co.in',
  ...
  const achievements = [
    ...
    '200+ JEE/NEET selections annually',
    'Modern infrastructure',
    'Strategic location near universities',
  ];
